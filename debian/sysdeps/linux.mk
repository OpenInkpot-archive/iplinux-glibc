GLIBC_OVERLAYS ?= $(shell ls glibc-linuxthreads* glibc-ports* glibc-libidn* glibc-manual*)
...
with_headers = --with-headers=$(shell pwd)/debian/include --enable-kernel=2.6.0
# this sucks:
